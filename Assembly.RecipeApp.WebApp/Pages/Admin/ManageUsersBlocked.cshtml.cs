...
{
    public class ManageUsersBlockedModel : PageModel
    {
        ...
        public ManageUsersBlockedModel(IUserService userService)
        {
        ...
        public IActionResult OnGet(int? selectedPage)
        {
            ...
            List<User> users = _userService.GetAllBlocked();
            ...
            Users = _userService.GetBlockedUsers(CurrentPage, PageSize);
