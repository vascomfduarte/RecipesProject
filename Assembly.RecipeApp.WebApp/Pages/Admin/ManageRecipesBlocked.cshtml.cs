...
{
    public class ManageRecipesBlockedModel : PageModel
    {
        ...
        public ManageRecipesBlockedModel(IUserService userService, IRecipeService recipeService)
        {
        ...
        public IActionResult OnGet(int? selectedPage)
        {
            ...
            var allRecipes = _recipeService.GetAllBlocked();
