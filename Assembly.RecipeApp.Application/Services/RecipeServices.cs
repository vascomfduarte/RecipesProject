...
namespace Assembly.RecipeApp.Application.Services
{
    public class RecipeServices : IRecipeService
    {
        ...
        public static Domain.Model.Recipe BuildRecipe(string recipeString)
        {
        ...
        public void GetFilteredProducts(string name)
        {
        ...
        public List<Domain.Model.Recipe> GetAll()
        {
            throw new NotImplementedException();
        }

        public Domain.Model.Recipe GetById(int id)
        {
        ...
        public void Add(Domain.Model.Recipe entity)
        {
            throw new NotImplementedException();
        }

        public void Update(Domain.Model.Recipe entity)
        {
            throw new NotImplementedException();
        }
